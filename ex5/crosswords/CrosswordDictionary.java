...
public interface CrosswordDictionary {
	...
	/**
	 * Loads dictionary from a text file. The dictionary format is defined in ex5 pdf.
	 * 
	...
	/**
	 * returns the total length of all the terms in this dictionary
	 */
	int getAllTermLength();	
	
	/**
	 * returns the length of the longest term in this dictionary
	 */
