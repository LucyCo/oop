...
/**
 * This class determines if a given file belongs to an "after" filter
 * 
 * @author alonaoz and lauren
 *
 */
public class After extends Filter {

	/**
	 * This method gets a file and a String represents a date and 
	 * return true if the given file was modified after the given date
	 */
